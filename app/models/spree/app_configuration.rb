...
module Spree
  class AppConfiguration < Preferences::Configuration
    ...
    preference :attachment_default_url, :string, :default => '/uploads/products/:id/:style/:basename.:extension'
    preference :attachment_path, :string, :default => ':rails_root/public/upload/products/:id/:style/:basename.:extension'
    preference :attachment_url, :string, :default => '/uploads/products/:id/:style/:basename.:extension'
